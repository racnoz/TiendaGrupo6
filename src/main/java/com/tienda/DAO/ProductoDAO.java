	...
	public ArrayList<ProductoDTO> consultarProducto(int codigo){
        ...
        try {
            ...
            if(res.next()) {
                ...
                producto.setPrecioCompra(Double.parseDouble(res.getString("preco_compra")));
            ...
            JOptionPane.showMessageDialog(null, "no se pudo consultar al producto "+e);
        }
        return miProducto;
    }
        ...
        try {
         ...
         while(res.next()){
          ...
          miProducto.add(producto);
        	 ...
        	 System.out.print("no se pudo consultar el producto "+e);
        }
        return miProducto;
    }
